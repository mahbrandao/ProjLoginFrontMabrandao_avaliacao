...
export function useLogin() {
    const router = useRouter(); // UM hoock para navegar entre pastas 
    ...
    function entrar(evento: React.FormEvent) {
        ...
        api.post('/users/auth', dadosLogin)// identificação de qual posht ele mandará
            .then((resposta) => {
    ...
    function cadastrar(evento: React.FormEvent) {
        ...
        api.post('/users/', dadosCadastros)// identificação de qual posht ele mandará
            .then((resposta) => {
